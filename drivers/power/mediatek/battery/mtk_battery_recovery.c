...
{
	//modify XLLSHLSS-925 by zhipeng.pan 20180207 start
	int init_swocv = get_ptim_vbat();
	//modify XLLSHLSS-925 by zhipeng.pan 20180207 end
	...
	if (rtc_ui_soc == 0 || con0_soc == 0) {
		...
		bm_err("[dod_init_recovery]rtcui=0,init_swocv=%d,OCV_to_SOC_c=%d,ui:%d con0_soc=%d\n",init_swocv,rtc_ui_soc,ui_d0_soc,con0_soc);
		//modify XLLSHLSS-925 by zhipeng.pan 20180207 end
	} else {
		ui_d0_soc = rtc_ui_soc;
