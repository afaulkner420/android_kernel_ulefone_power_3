...
static int __init mt6763_dts_register_platform(void)
{
...
module_init(mt6763_dts_register_platform);

static void __exit mt6763_dts__dev_exit(void)
{
}
module_exit(mt6763_dts__dev_exit);
