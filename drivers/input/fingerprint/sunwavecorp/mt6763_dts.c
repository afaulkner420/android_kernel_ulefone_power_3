...
int mt6763_dts_reset(struct spi_device**  spi)
{
...
static int  mt6763_dts_gpio_init(struct spi_device**   spidev)
{
...
static int  mt6763_dts_irq_hander(struct spi_device** spi)
{
  spi_to_sunwave(spi);
  return 0;
}
...
static int mt6763_dts_speed(struct spi_device**    spi, unsigned int speed)
{
...
static finger_t  finger_sensor = {
    ...
    .write_then_read        = 0,
    .irq_hander             = mt6763_dts_irq_hander,
    .irq_request            = 0,
    .irq_free               = 0,
    .init                   = mt6763_dts_gpio_init,
    .reset                  = mt6763_dts_reset,
    .speed          = mt6763_dts_speed,
};


void mt6763_dts_register_finger(sunwave_sensor_t*    sunwave)
{
    sunwave->finger = &finger_sensor;
}
EXPORT_SYMBOL_GPL(mt6763_dts_register_finger);
