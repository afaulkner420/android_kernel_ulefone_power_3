...
*/
	...
	bf_dev->pins_power_1v8_high = pinctrl_lookup_state (bf_dev->pinctrl_gpios, "power1v8_en_output1");
	...
	bf_dev->pins_power_1v8_low = pinctrl_lookup_state (bf_dev->pinctrl_gpios, "power1v8_en_output0");
	...
	bf_dev->irq_gpio =  of_get_named_gpio(bf_dev->spi->dev.of_node, "touch-int-gpio", 0);
