...
//ihdr_write_shutter_gain not support for s5k3p9
/*
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
	...
	if (imgsensor.ihdr_en) {
		...
		write_cmos_sensor(0x0340, imgsensor.frame_length & 0xFFFF);
	  write_cmos_sensor(0X0202, shutter & 0xFFFF);
   	write_cmos_sensor(0X021e, shutter & 0xFFFF);
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor(0x0100,0x0000);  
	...
	write_cmos_sensor(0x0310,0x0074); //modify setting by ming.liao 20171220
	write_cmos_sensor(0x0312,0x0001); //modify setting by ming.liao 20171220
	write_cmos_sensor(0x0340,0x0E54); //72A
...
{
	LOG_INF("enable: %d\n", enable);
	//modify factory test by ming.liao 20171212 start
	if (enable) {
	...
	//modify factory test by ming.liao 20171212 end
	spin_lock(&imgsensor_drv_lock);
