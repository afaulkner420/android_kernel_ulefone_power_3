...
static struct LCM_setting_table bl_level[] = {
    {0x51, 2, {0xFF,0x00}},
    {0xB0, 2, {0xA5,0x00}},
    {0xB8,15, {0x0A,0x00,0x01,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x14,0x14,0x00,0x00}},
    {REGFLAG_END_OF_TABLE, 0x00, {}}
};
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    if (level > 0x2C) {
        bl_level[2].para_list[13] = 0x2A;
        bl_level[2].para_list[14] = 0x2A;
    } else {
        bl_level[2].para_list[13] = 0x20;
        bl_level[2].para_list[14] = 0x20;
    }
