...
/*=======================================================================================*/
/* ICM206XX Sensor Interrupt Feature enable/disable					 */
/* Step Detector and SMD needs interrupt, so this feature should be enabled		 */
/* If Step Detector and SMD is not used, this feature can be disabled			 */
/*=======================================================================================*/

//#define ICM206XX_USE_INTERRUPT
...
extern void icm206xx_share_set_sensor_power(int paramSensor, bool paramPower);
extern bool icm206xx_share_get_sensor_power(int paramSensor);
extern bool icm206xx_share_any_step_sensor_is_on(int paramSensor);

extern int icm206xx_share_ChipSoftReset(void);
extern int icm206xx_share_SetPowerMode(int sensor_type, bool enable);
extern int icm206xx_share_EnableInterrupt(u8 int_type, bool enable);
