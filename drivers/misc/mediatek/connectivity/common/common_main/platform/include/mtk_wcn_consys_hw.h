...
typedef UINT32 (*CONSYS_IC_READ_CHIPID) (VOID);
typedef VOID (*CONSYS_IC_CPU_SW_RST) (VOID);
typedef VOID (*CONSYS_IC_CPU_SW_RST_DEASSERT) (VOID);
...
typedef struct _WMT_CONSYS_IC_OPS_ {
	...
	CONSYS_IC_READ_CHIPID consys_ic_read_chipid;
	CONSYS_IC_CPU_SW_RST consys_ic_cpu_sw_rst;
	CONSYS_IC_CPU_SW_RST_DEASSERT consys_ic_cpu_sw_rst_deassert;
...
UINT32 mtk_wcn_consys_read_chipid(VOID);
VOID mtk_wcn_consys_cpu_sw_rst(VOID);
VOID mtk_wcn_consys_cpu_sw_rst_deassert(VOID);
