...
{
	if (wmt_consys_ic_ops->consys_ic_read_chipid)
		return wmt_consys_ic_ops->consys_ic_read_chipid();
	else
		return 0;
}
...
{
	if (wmt_consys_ic_ops->consys_ic_cpu_sw_rst)
		wmt_consys_ic_ops->consys_ic_cpu_sw_rst();
}

VOID mtk_wcn_consys_cpu_sw_rst_deassert(VOID)
{
	if (wmt_consys_ic_ops->consys_ic_cpu_sw_rst_deassert)
		wmt_consys_ic_ops->consys_ic_cpu_sw_rst_deassert();
}
