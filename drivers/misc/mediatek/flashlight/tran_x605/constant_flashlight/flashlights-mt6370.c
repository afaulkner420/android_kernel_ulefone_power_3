...
static int mt6370_set_level_ch1(int level)
{
	...
	if(mt6370_level_ch1 == 28)
	{
		flashlight_set_torch_brightness(
				flashlight_dev_ch1, mt6370_torch_level[0]);
		flashlight_set_torch_brightness(
				flashlight_dev_ch2, mt6370_torch_level[0]);
	}
	else if(mt6370_level_ch1 == 29)
	{
		flashlight_set_torch_brightness(
				flashlight_dev_ch1, mt6370_torch_level[4]);
		flashlight_set_torch_brightness(
				flashlight_dev_ch2, mt6370_torch_level[4]);
