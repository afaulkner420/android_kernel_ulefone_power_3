...
#define DW9763AF_F_SetI2Cclient DW9763AF_F_SetI2Cclient_Main2
#define DW9763AF_F_Ioctl DW9763AF_F_Ioctl_Main2
#define DW9763AF_F_Release DW9763AF_F_Release_Main2
extern int DW9763AF_F_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9763AF_F_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9763AF_F_Release(struct inode *a_pstInode, struct file *a_pstFile);
