...
/*
 * DW9763AF_F voice coil motor driver
 *
 *
 */
#include <linux/i2c.h>
...
#define AF_DRVNAME "DW9763AF_F_DRV"
...
u8 DW9763AF_F_read_data(u8 addr)
{
	u8 get_byte=0;
    i2c_read( addr ,&get_byte);
    LOG_INF("[DW9763AF_F]  get_byte %d \n",  get_byte);
    return get_byte;
}
 ...
 *a_pu2Result = (DW9763AF_F_read_data(0x03) << 8) + (DW9763AF_F_read_data(0x04)&0xff);
...
/* ////////////////////////////////////////////////////////////// */
long DW9763AF_F_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9763AF_F_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int DW9763AF_F_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
