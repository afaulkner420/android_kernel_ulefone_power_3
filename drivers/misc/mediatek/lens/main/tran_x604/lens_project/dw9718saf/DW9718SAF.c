...
//modify XLLSHLSS-281 by ming.liao 2010105 start
	char puSendCmd3[2] = { 0x05, 0x7E };
//add af_VDD by ming.liao 20171204 start
#if defined (TRAN_X604)
...
//add af_VDD by ming.liao 20171204 end
	...
	msleep(1);
	//printk(KERN_ERR "dw9718:%d,%d\n",read_data(0x01),read_data(0x05));
//modify XLLSHLSS-281 by ming.liao 2010105 end
	if (i4RetValue < 0)
		return -1;
