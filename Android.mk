...
$(BUILT_KERNEL_TARGET): $(KERNEL_ZIMAGE_OUT) $(TARGET_KERNEL_CONFIG) $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/scripts/post_process_dtbs.py
	$(copy-file-to-target-with-cp)
	python $(KERNEL_DIR)/scripts/post_process_dtbs.py $@

$(TARGET_PREBUILT_KERNEL): $(BUILT_KERNEL_TARGET) $(LOCAL_PATH)/Android.mk
	$(copy-file-to-target-with-cp)
...
$(INSTALLED_KERNEL_TARGET): $(BUILT_KERNEL_TARGET) $(LOCAL_PATH)/Android.mk
	$(copy-file-to-target-with-cp)
